...
class _PlantDetailPageState extends State<Monstera> {
  int quantity = 1;
  bool isLiked = false;
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Image.asset(
              'assets/images/wepik-export-20230503085419 2.png', // Replace with your image path
              width: 350,
              height: 350,
            ),
          ),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 5),
                Text(
                  'Monstera deliciosa, commonly known as the Swiss cheese plant or split-leaf philodendron, is a popular tropical plant native to the rainforests of Central and South America. It belongs to the family Araceae and is known for its large, glossy, heart-shaped leaves that develop unique perforations and splits as they mature, resembling Swiss cheese.',
                  style: TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.normal,
                  ),
