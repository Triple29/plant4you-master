...
class Calathea extends StatefulWidget {
  @override
  _PlantDetailPageState createState() => _PlantDetailPageState();
}

class _PlantDetailPageState extends State<Calathea> {
  int quantity = 1;
  bool isLiked = false;
      ...
      body: Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Image.asset(
              'assets/images/image 7.png', // Replace with your image path
              width: 350,
              height: 350,
            ),
          ),
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 5),
                Text(
                  'Calathea makoyana is treasured for its attractive foliage and can be a stunning addition to your indoor plant collection. Remember to provide it with the right conditions of light, humidity, and watering to keep it healthy and thriving.',
                  style: TextStyle(
                    fontSize: 14,
                    fontWeight: FontWeight.normal,
                  ),
